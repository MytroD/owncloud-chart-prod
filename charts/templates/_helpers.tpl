First helm chart for lens + kubernetes cluster
This will create a standalone redis, postgresql as database, service, ingress and add nfs storage
All config will be tranfered to values.yaml. so whole deployment process can be controlled from values.yaml.
